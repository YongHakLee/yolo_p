...
class BaseTrainer:
    ...
    def _setup_train(self, world_size):
        ...
        if self.args.freeze in ["1", "2", "3", "4", "5"]:
            frz_opts = {
                "1": [f"model.{x}." for x in list(range(23))]
                + [
                    "model.23.cv2",
                    "model.23.cv3.0.0",
                    "model.23.cv3.0.1",
                ...
                "2": [f"model.{x}." for x in list(range(23))]
                + [
                    "model.23.cv2",
                    "model.23.cv3.0.0",
                    "model.23.cv3.0.1",
                ...
                "3": [f"model.{x}." for x in list(range(23))]
                + [
                    "model.23.cv2",
                    "model.23.cv3.0.0",
                    "model.23.cv3.0.1",
                ...
                "4": [f"model.{x}." for x in list(range(23))]
                + [
                    "model.23.cv2",
                    "model.23.cv3.0.0",
                    "model.23.cv3.0.1",
                ...
                "5": [f"model.{x}." for x in list(range(23))]
                + [
                    "model.23.cv2",
                    "model.23.cv3.0.0",
                    "model.23.cv3.0.1",
            ...
            freeze_layer_names = frz_opts[self.args.freeze]
            self.args.freeze = freeze_layer_names
